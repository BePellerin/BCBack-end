 ...
 */
final class Version20231004162513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE collecs (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, cover_pict VARCHAR(255) DEFAULT NULL, avatar_pict VARCHAR(255) DEFAULT NULL, blockchain VARCHAR(255) NOT NULL, website_url VARCHAR(255) DEFAULT NULL, INDEX IDX_3A62F75712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
