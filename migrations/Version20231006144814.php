 ...
 */
final class Version20231006144814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nft (id INT AUTO_INCREMENT NOT NULL, collec_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(300) DEFAULT NULL, ceated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', price INT DEFAULT NULL, pict VARCHAR(255) NOT NULL, creator VARCHAR(255) NOT NULL, INDEX IDX_D9C7463C584D4E9A (collec_id), INDEX IDX_D9C7463CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
